...
import "@splidejs/splide/dist/css/themes/splide-default.min.css"; // Import Splide default theme styles
  ...
  return (
    <>
      ...
      <div className="hidden lg:flex w-[1520px] m-auto py-2 px-2">
        <Splide
          options={{ perPage: 5, gap: "0.5rem", drag: "free", arrows: false }}
        >
          {topPicks.map((item) => (
